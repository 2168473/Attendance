...
<div class="ui borderless menu" id="header">
    <div class="ui container"><a href="">
        ...
        <a class="ui right floated dropdown item" id="dropdown">
            <?php if(isset($_SESSION['id'])){echo $_SESSION['user'];}else {echo 'User';}?>
    ...
    <div id="mixedSlider">
        <div class="MS-content">
            ...
            <div class="item">
                ...
                <p>Calle Uno is located at 3 Josefa Llanes Escoda (First Road) corner Naguilian Road,  Quezon Hill,  Baguio City</p>
            ...
            <div class="item">
                ...
                <p>The whole Calle Uno team just genuinely wants you to be successful. The staff members have helped us grow... -Jackie and John (O'Connor Web Agency)</p>
                <a href="#">Read More</a>
            </div>
            <div class="item">
                <div class="imgTitle">
